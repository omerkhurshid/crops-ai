      ...
      <main className="max-w-4xl mx-auto pt-8 pb-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-4">
            <Brain className="h-6 w-6 text-[#5E6F5A]" />
            <span className="text-[#7A8F78]">AI Recommendations</span>
          </div>
              ...
              <div className="space-y-4">
                <div className="bg-[#F8FAF8] p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <h5 className="font-medium text-[#5E6F5A] mb-2">
                        Real-Time Inputs
                      </h5>
          ...
          <ModernCardContent className="p-8">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 text-sm text-[#7A8F78]">
                ...
                <div className="flex items-start gap-3">
                  <div className="bg-[#F8FAF8] p-2 rounded-lg">
                    <DollarSign className="h-5 w-5 text-[#7A8F78]" />
                  </div>
                  <div className="flex-1">
                    <h4 className="font-semibold text-[#7A8F78]">
                      ROI Score (0-10)
              ...
              <div className="bg-[#F8FAF8] p-4 rounded-lg">
                ...
                <p className="text-[#7A8F78] text-sm mt-2">
        ...
        <ModernCard variant="soft" className="mb-8">
          ...
          <ModernCardContent className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <CloudRain className="h-5 w-5 text-[#555555]" />
                  <h4 className="font-semibold text-[#7A8F78]">
