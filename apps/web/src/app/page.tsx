    ...
    <div className="min-h-screen bg-gradient-to-br from-sage-50 to-earth-50">
          ...
          <div className="text-center mb-16 p-8 md:p-12 bg-white rounded-2xl shadow-xl border border-sage-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 max-w-5xl mx-auto">
              <div className="bg-sage-50 p-6 rounded-lg border border-sage-200">
                <Satellite className="h-10 w-10 text-sage-600 mb-3 mx-auto" />
                <h3 className="text-lg font-semibold text-sage-700 mb-2">Satellite Monitoring</h3>
                <p className="text-sage-600">Real-time crop health tracking with NDVI analysis</p>
              </div>
              <div className="bg-earth-50 p-6 rounded-lg border border-earth-200">
                <Brain className="h-10 w-10 text-earth-600 mb-3 mx-auto" />
                <h3 className="text-lg font-semibold text-earth-700 mb-2">AI Analytics</h3>
                <p className="text-earth-600">Smart recommendations and predictive insights</p>
              </div>
              <div className="bg-cream-50 p-6 rounded-lg border border-cream-200">
                <BarChart className="h-10 w-10 text-golden mb-3 mx-auto" />
                <h3 className="text-lg font-semibold text-golden mb-2">Data Management</h3>
                <p className="text-golden">Comprehensive farm records and analytics</p>
              </div>
            </div>
            ...
            <div className="mb-6">
              <Link href="/register">
                <button className="bg-sage-600 hover:bg-sage-700 px-8 py-4 text-white font-semibold text-lg rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl inline-flex items-center mb-4">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/register">
            <button className="bg-sage-600 hover:bg-sage-700 px-8 py-4 text-white font-semibold text-lg rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl inline-flex items-center">
