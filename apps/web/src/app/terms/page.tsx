...
export default function TermsOfServicePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-#F8FAF8 to-cream-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h1 className="text-4xl font-bold text-[#7A8F78] mb-4">Terms of Service</h1>
          <p className="text-[#7A8F78] mb-8">Last updated: {new Date().toLocaleDateString()}</p>
          <div className="prose prose-sage max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">1. Acceptance of Terms</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">2. Description of Service</h2>
              <p className="text-[#5E6F5A] mb-4">
                Cropple.ai provides an agricultural management platform that offers:
              </p>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">3. User Accounts and Eligibility</h2>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">3.1 Account Creation</h3>
              <p className="text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">3.2 Account Security</h3>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">3.3 Eligibility</h3>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">4. Subscription Plans and Payments</h2>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">4.1 Service Plans</h3>
              <p className="text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">4.2 Payment Terms</h3>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">4.3 Cancellation and Refunds</h3>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">5. User Content and Data</h2>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">5.1 Your Content</h3>
              <p className="text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">5.2 Content Standards</h3>
              <p className="text-[#5E6F5A] mb-4">You agree not to submit User Content that:</p>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">5.3 Data Backup and Recovery</h3>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">6. Acceptable Use Policy</h2>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">6.1 Permitted Uses</h3>
              <p className="text-[#5E6F5A] mb-4">You may use the Service for legitimate agricultural management purposes in accordance with these Terms.</p>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">6.2 Prohibited Uses</h3>
              <p className="text-[#5E6F5A] mb-4">You agree not to:</p>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">7. AI and Machine Learning Services</h2>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">7.1 AI-Generated Content</h3>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">7.2 Model Training</h3>
              <p className="text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">8. Third-Party Services and Data</h2>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">8.1 Third-Party Integrations</h3>
              <p className="text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">8.2 Third-Party Data</h3>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">9. Intellectual Property Rights</h2>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">9.1 Our Rights</h3>
              <p className="text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">9.2 Limited License</h3>
              <p className="text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">9.3 Feedback</h3>
              <p className="text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">10. Privacy and Data Protection</h2>
              <p className="text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">11. Service Availability and Modifications</h2>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">11.1 Service Availability</h3>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">11.2 Service Modifications</h3>
              <p className="text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">12. Disclaimers and Limitations</h2>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">12.1 Service Disclaimer</h3>
              <p className="text-[#5E6F5A] mb-4 font-semibold">
                THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT.
              </p>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">12.2 Agricultural Decisions</h3>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">12.3 Limitation of Liability</h3>
              <p className="text-[#5E6F5A] mb-4 font-semibold">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">13. Indemnification</h2>
              <p className="text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">14. Termination</h2>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">14.1 Termination by You</h3>
              <p className="text-[#5E6F5A] mb-4">
                You may terminate your account at any time by following the cancellation process in your account settings.
              </p>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">14.2 Termination by Us</h3>
              <p className="text-[#5E6F5A] mb-4">We may terminate or suspend your account immediately, without prior notice, for:</p>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">14.3 Effect of Termination</h3>
              <ul className="list-disc pl-6 text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">15. Dispute Resolution</h2>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">15.1 Informal Resolution</h3>
              <p className="text-[#5E6F5A] mb-4">
                Before initiating formal dispute resolution, we encourage you to contact us to seek informal resolution of any disputes.
              </p>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">15.2 Binding Arbitration</h3>
              <p className="text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">15.3 Class Action Waiver</h3>
              <p className="text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">16. International Users</h2>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">16.1 Global Access</h3>
              <p className="text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">16.2 Local Laws</h3>
              <p className="text-[#5E6F5A] mb-4">
              ...
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">16.3 Export Controls</h3>
              <p className="text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">17. Governing Law and Jurisdiction</h2>
              <p className="text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">18. General Provisions</h2>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">18.1 Entire Agreement</h3>
              <p className="text-[#5E6F5A] mb-4">
                These Terms, together with our Privacy Policy, constitute the entire agreement between you and us regarding the Service.
              </p>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">18.2 Severability</h3>
              <p className="text-[#5E6F5A] mb-4">
                If any provision of these Terms is found to be unenforceable, the remaining provisions will remain in full force and effect.
              </p>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">18.3 Waiver</h3>
              <p className="text-[#5E6F5A] mb-4">
                No waiver of any term of these Terms shall be deemed a further or continuing waiver of such term or any other term.
              </p>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">18.4 Assignment</h3>
              <p className="text-[#5E6F5A] mb-4">
                You may not assign or transfer these Terms without our written consent. We may assign these Terms without restriction.
              </p>
              <h3 className="text-xl font-semibold text-[#5E6F5A] mb-3">18.5 Updates to Terms</h3>
              <p className="text-[#5E6F5A] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#7A8F78] mb-4">19. Contact Information</h2>
              <p className="text-[#5E6F5A] mb-4">
                If you have any questions about these Terms of Service, please contact us:
              </p>
              <div className="bg-[#F8FAF8] p-6 rounded-lg">
                <p className="text-[#5E6F5A] mb-2"><strong>Email:</strong> legal@cropple.ai</p>
                <p className="text-[#5E6F5A] mb-2"><strong>Support:</strong> support@cropple.ai</p>
                <p className="text-[#5E6F5A] mb-2"><strong>Mailing Address:</strong></p>
                <p className="text-[#5E6F5A] mb-2">
                  Cropple.ai Inc.<br />
                  Legal Department<br />
                ...
                <p className="text-[#5E6F5A]"><strong>Phone:</strong> [Your Phone Number]</p>
              </div>
            </section>
          </div>
        </div>
