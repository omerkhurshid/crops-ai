...
export function ColorfulFarmTable({ farms, onFarmSelect }: ColorfulFarmTableProps) {
  ...
  const getProfitColor = (profit: number) => {
    ...
    if (profit > 20000) return 'bg-[#8FBF7F]'
  ...
  return (
    <Card>
      <CardHeader className="bg-gradient-to-r from-sage-50 to-#FAFAF7">
        <div className="flex items-center justify-between">
          ...
          <Badge variant="outline" className="text-[#555555]">
            {farms.length} Farms
          </Badge>
        </div>
      </CardHeader>
          ...
          <table className="w-full">
            <thead className="bg-[#FAFAF7] border-b border-[#E6E6E6]">
              <tr>
                ...
                <th className="px-6 py-4 text-center text-xs font-medium text-[#555555] uppercase tracking-wider">
                  Area
                </th>
                <th className="px-6 py-4 text-right text-xs font-medium text-[#555555] uppercase tracking-wider">
                  Revenue
                </th>
                <th className="px-6 py-4 text-right text-xs font-medium text-[#555555] uppercase tracking-wider">
                  Expenses
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right">
                    <div className="flex items-center justify-end gap-3">
                      <div className="w-24">
                        <div className="relative h-6 bg-[#F5F5F5] rounded-full overflow-hidden">
                          <div 
                            className={cn(
                              "absolute top-0 h-full rounded-full transition-all duration-500",
                              farm.netProfit >= 0 ? "bg-[#8FBF7F] left-0" : "bg-red-500 right-0"
                            )}
                            style={{ 
