    ...
    <div className="space-y-6">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    {record.mate ? (
                      <div>
                        ...
                        {record.mate.name && (
                          <div className="text-sm text-[#555555]">{record.mate.name}</div>
                        )}
                      </div>
                    ) : (
                      ...
                      <div>
                        ...
                        {daysUntilDue !== null && (
                          <div className={`text-xs flex items-center gap-1 ${
                            ...
                            daysUntilDue <= 7 ? 'text-orange-600' : 'text-[#555555]'
                          }`}>
      ...
      {filteredRecords.length === 0 && searchTerm && (
        <div className="text-center py-8">
          <p className="text-[#555555]">No breeding records found matching your search criteria.</p>
        </div>
      )}
    </div>
  )
